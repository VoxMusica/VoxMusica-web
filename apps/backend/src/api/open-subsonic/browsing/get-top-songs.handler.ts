import { getTopSongsSchema, type GetTopSongsQueryParams, type GetTopSongsReply, type OpenSubsonicRequest } from "@voxmusica/types"
import ms from "ms"
...
type GetTopSongsParams = OpenSubsonicRequest & {
